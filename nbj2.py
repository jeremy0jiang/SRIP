...
def nbj(cur):
    ...
    if (len(childList) > 2):
        ...
        print subtree.seed_node.parent_node, "*******************"
        print "subtree:"
...
#print tree.update_taxon_namespace()
#tree.seed_node.label = root.label
#tree.is_rooted=True
newnode=dendropy.Node()
newnode.edge_length=100
newnode.label="new"
#tree.seed_node.child_nodes()[0].add_child(newnode)
